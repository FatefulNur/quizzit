            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="flex flex-col ml-3">
                        <div class="font-medium leading-none">Thanks!</div>
                        <p class="mt-1 text-sm leading-none text-gray-600">
                            Your feedback has added. Check you result...
                        </p>
                    </div>
                </div>
                <a href="{{ route('user.responses.show', $response) }}" class="px-5 py-2 ml-4 text-sm font-medium tracking-wider text-white bg-red-500 border-2 border-red-500 rounded-full shadow-sm flex-no-shrink hover:shadow-lg">Check</a>
            </div>
        </div>
    </div>
</x-frontend-layout>
