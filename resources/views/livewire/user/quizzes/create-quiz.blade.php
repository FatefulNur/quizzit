            ...
            <div class="flex items-start justify-between gap-2 space-y-1 text-right">
                <div class="flex flex-col justify-center w-full max-w-xs">
                    ...
                    @enderror">
                        ...
                        <input wire:model="started_at" class="w-0 p-0 border-none" type="text" name="started_at"
                            id="started_at" style="box-shadow: none" data-picker>
                        Start Date
                    </label>
                    @error('started_at')
