        ...
        @if ($product)
            <div class="space-y-2 sm:flex sm:flex-wrap sm:justify-between">
                ...
                <div
                    ...
                    <div>
                        <span class="text-lg font-bold text-slate-600">{{ $product->name }}</span>
                    ...
                    <div class="flex gap-4 p-4 border border-indigo-600 rounded-lg">
                        <span class="inline-flex items-start gap-1 text-xs font-bold text-gray-600">
                            BDT
                            <span
                                class="h-full text-3xl font-extrabold text-slate-800">{{ number_format($product->price * 0.01, 2) }}</span>
                        </span>
                            ...
                            <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-4">
                                    <label for="region"
                                        ...
                                        Province</label>
                                    <div class="mt-2">
                                        <input wire:model.blur="form.region" type="text" name="region"
